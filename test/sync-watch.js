...
describe( "sync-watch", function() {
	...
	[ {
		...
		describe( "sync-watch", function() {
			var hook, hookErr, webDavServer, serverDir, syncPoint, tempDir, emitter;
						...
						if ( name == "idle" && !stop ) {
							...
							setTimeout( function() {
								...
								helper.asyncCheck( function( e ) {
									...
									hookErr.captured().should.containEql( "<error> sync.js:" );
									hookErr.captured().should.containEql( "{\"url\":\"http://127.0.0.1:10039/dav/fs-type1/themes/Theme%20One/css/hello.css\"," );
									hookErr.captured().should.containEql( "{\"url\":\"http://127.0.0.1:10039/dav/fs-type1/themes/Theme%20One/preview.png\"," );
									hookErr.captured().should.containEql( "{\"url\":\"http://127.0.0.1:10039/dav/fs-type1/themes/Theme%20One/js\"," );
						...
						if ( name == "idle" && !stop ) {
							...
							setTimeout( function() {
								...
								helper.asyncCheck( function( e ) {
									...
									hookErr.captured().should.containEql( "<error> sync.js:" );
									hookErr.captured().should.containEql( "{\"url\":\"http://127.0.0.1:10039/dav/fs-type1/themes/Theme%20One/read%20me.txt\"," );
								} );
